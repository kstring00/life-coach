...
import { process, faqs } from '@/data/site';
    ...
    <main>
      ...
      <section className="section-shell section-pad">
        <div className="section-bridge">
          ...
          <p>Six focused coaching paths. Explore one at a time so you can understand the difference without having to scan everything at once.</p>
        </div>
        <ServicesCarousel />
      </section>
