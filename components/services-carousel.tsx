  ...
  return (
    <div className="services-explorer" aria-label="Coaching services explorer">
      ...
      <style jsx>{`
        ...
        .services-explorer-tab{min-height:72px;border:0;border-bottom:1px solid #dde2e6;background:transparent;color:#182431;display:grid;grid-template-columns:38px 1px 1fr;align-items:center;gap:14px;padding:0 22px;text-align:left;font-size:.9rem;cursor:pointer;transition:.2s ease}
        ...
        .services-explorer-panel{position:relative;min-height:520px;border:1px solid #d5dbe1;border-radius:28px;overflow:hidden;background:#fbfaf7;display:flex;align-items:center;padding:clamp(34px,5vw,72px)}
        ...
        .services-explorer-content{position:relative;z-index:2;max-width:570px}.services-explorer-icon{width:52px;height:52px;border-radius:50%;background:#10263d;color:#fff;display:grid;place-items:center;margin-bottom:28px}.services-explorer-kicker{font-size:.67rem;letter-spacing:.14em;font-weight:800;color:#304f6d;margin:0 0 14px}.services-explorer-content h3{font-family:var(--font-display);font-weight:600;color:#111820;font-size:clamp(2rem,3.2vw,3rem);line-height:1.02;letter-spacing:-.025em;max-width:560px;margin:0}.services-explorer-copy{font-size:.92rem;line-height:1.65;color:#65707a;max-width:520px;margin:20px 0 26px}.services-explorer-controls{display:flex;align-items:center;gap:14px;margin-top:28px}.services-arrow{width:42px;height:42px;border-radius:50%;border:1px solid #d2d8de;background:#f8f8f6;color:#18304a;display:grid;place-items:center;cursor:pointer}.services-arrow:hover{background:#eef1f4}.services-dots{display:flex;gap:10px;align-items:center}.services-dots button{width:8px;height:8px;border-radius:50%;border:0;background:#c5c9cd;padding:0;cursor:pointer}.services-dots button.active{background:#18304a}
        @media(max-width:900px){.services-explorer{grid-template-columns:1fr}.services-explorer-list{grid-template-columns:repeat(3,1fr)}.services-explorer-tab{grid-template-columns:30px 1fr;gap:8px;min-height:66px;padding:10px 14px;border-right:1px solid #dde2e6}.services-explorer-divider{display:none}.services-explorer-panel{min-height:460px}}
        @media(max-width:620px){.services-explorer-list{display:flex;overflow-x:auto;border-radius:18px;scroll-snap-type:x proximity}.services-explorer-tab{min-width:210px;grid-template-columns:28px 1fr;border-bottom:0;border-right:1px solid #dde2e6;scroll-snap-align:start}.services-explorer-panel{min-height:500px;padding:30px 24px;align-items:flex-start}.services-explorer-panel:before{background:linear-gradient(180deg,#fbfaf7 0%,rgba(251,250,247,.97) 66%,rgba(251,250,247,.55) 86%,rgba(251,250,247,.2) 100%)}.services-explorer-panel:after{right:-20%;bottom:-18%;width:92%;height:48%}.services-explorer-content h3{font-size:2.15rem}.services-explorer-copy{font-size:.88rem}}
      `}</style>
    </div>
  );
}
